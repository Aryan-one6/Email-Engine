...
const steps = [
  {
    ...
    description: 'Set up your workspace, import leads, and map name/email fields in a guided onboarding flow.',
    icon: Database,
  },
  {
    id: '02',
    title: 'Activate AI email workflows',
    description: 'Configure templates, automation rules, and follow-up sequences for each segment.',
    icon: Bot,
  },
  {
    id: '03',
