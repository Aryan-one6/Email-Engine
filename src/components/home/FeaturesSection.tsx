import { Bot, Download, ListChecks, Mail, ShieldCheck, Table2 } from 'lucide-react';
...
const features = [
  ...
  },
  {
    ...
    description: 'Build segments from record fields and engagement activity for precise targeting.',
    icon: Mail,
  },
  {
    title: 'AI Content Assistant',
    description: 'Generate campaign drafts, subject lines, and structured follow-up copy.',
    icon: Bot,
  },
  {
    title: 'Campaign Delivery Queue',
    description: 'Review delivery outcomes, retry failed sends, and handle exceptions quickly.',
    icon: Table2,
  },
  {
