...
const plans = [
  {
    name: 'Starter',
    price: '$79',
    description: 'For small teams launching shared email operations.',
  ...
  },
  {
    name: 'Growth',
    price: '$229',
    description: 'For teams scaling outreach automation.',
    features: ['Up to 15 team seats', 'Automation sequences + campaign scheduling', 'Priority support'],
    cta: 'Choose Growth',
    highlighted: true,
  },
  {
