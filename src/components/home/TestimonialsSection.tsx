...
const testimonials = [
  ...
  {
    quote:
      'The shared workspace model keeps records, email activity, and imports aligned for every team in one place.',
    name: 'Michael Shen',
  ...
  {
    quote:
      'Audience setup and campaign mapping now run in one repeatable process without extra engineering involvement.',
