        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          <LandingReveal className="relative">
            ...
            <h1 className="mt-5 font-display text-4xl font-semibold leading-[1.02] tracking-[-0.035em] text-slate-900 sm:text-5xl lg:text-6xl">
              Run lead imports, email automation, and campaign execution from one command center.
            </h1>
            <p className="mt-6 max-w-[36rem] text-base leading-8 text-slate-700/95 sm:text-[1.06rem]">
              Email Engine unifies team workflows, audience management, and campaign execution in a single system built
              for fast-moving growth teams.
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-2.5 text-sm text-slate-700">
              <span className="font-semibold text-slate-900">Used by teams for:</span>
              {['Lead Nurture', 'Sales Follow-up', 'Lifecycle Campaigns', 'Re-engagement'].map((industry) => (
                <span
                  key={industry}
            ...
            >
              ...
              <div className="relative overflow-hidden rounded-2xl border border-slate-500/30 bg-white/95 p-4 shadow-[0_18px_40px_rgba(15,23,42,0.4)]">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-3">
                  {[
                    { label: 'Leads Processed', value: '12.4k' },
                ...
                <div className="mt-4 rounded-xl border border-slate-200 bg-white p-3">
                  ...
                  <div className="space-y-2.5">
                    {[
                      ...
                      { caller: 'L. Chen', intent: 'Follow-up', status: 'In Review' },
                      { caller: 'R. Patel', intent: 'Demo Request', status: 'Closed' },
                    ].map((row) => (
                      <div
                        key={row.caller}
