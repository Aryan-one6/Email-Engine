...
const faqs = [
  {
    ...
    answer:
      'Most teams launch their first workflow in under a week. We provide guided setup for records, imports, and email automation.',
  },
  {
    question: 'Can we customize this for our own company branding?',
    answer:
      'Yes. Template variables support dynamic sender and workspace/company values, so each message stays personalized.',
  },
  {
    question: 'Do you support role-based access control?',
    answer:
      'Absolutely. Workspace owners can assign permissions by role and control access to records, campaigns, and team settings.',
  },
  {
    question: 'Can we customize email automation?',
    answer:
      'You can configure templates, follow-up steps, and audience targeting to align with your outreach process.',
  },
];
