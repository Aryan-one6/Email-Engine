...
export function CompleteOnboardingPage() {
  return (
    <AuthLayout
      ...
      title="Complete your workspace setup to enter Email Engine."
      description="This account is authenticated, but it does not have a workspace yet. Add the workspace name and slug to finish onboarding."
