...
const REQUIRED_LEAD_CORE_TARGET_KEYS = new Set(['full_name', 'email']);

const coreTargetHelpText: Record<string, string> = {
  title: 'Optional record title (auto-filled if empty)',
  full_name: 'Required lead name',
...
export function ImportsPage() {
  ...
  usePageGuide({
    key: 'imports-jobs',
    title: 'Prepare a lead import',
    summary:
      'Use this page to upload a CSV, map its columns to lead fields, and review preview rows before importing leads into Email Engine.',
    nextStep:
      columns.length === 0
        ? 'Choose a CSV file first so Email Engine can inspect the columns and prepare the import.'
    ...
    steps: [
      {
        ...
        body: 'Upload the source file here so Email Engine can detect columns and suggest field mappings for this workspace.',
        targetId: 'imports-file-input',
      },
      {
        id: 'imports-create-job',
        title: 'Run the import',
        body: 'This action creates the import job, stores all parsed rows, and imports leads using the selected field mappings.',
      ...
      },
      {
        ...
        body: 'Use the mapping section to connect each incoming column to the correct core or custom lead field. Lead name and email are required.',
    ...
    <WorkspaceLayout workspace={workspace} onSignOut={handleSignOut}>
      <div className="space-y-6 ">
        <PageHeader
          eyebrow="Imports"
          title="Import leads"
          description="Upload a CSV, map columns to lead fields, preview data, and import leads into Email Engine."
        />
        ...
        <Card className="overflow-hidden border-slate-200 bg-gradient-to-br from-white via-slate-50 to-indigo-50 p-6 shadow-lg shadow-slate-200/60">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <h2 className="mt-1 font-display text-xl text-slate-900">CSV to Leads</h2>
              </div>
            ...
            <div className="mt-5 rounded-2xl border border-slate-200 bg-white p-4">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <p className="mt-1 text-sm text-slate-600">
                    These fields already exist in your workspace. Map lead name and email before creating the import job.
                </p>
              </div>
                <button
                  type="button"
                ...
                <div className="rounded-2xl border border-slate-200 p-4">
                  ...
                  <div className="mt-3 grid gap-2 md:grid-cols-5">
                    ...
                    <select
                      ...
                      className="h-10 rounded-xl border border-slate-200 bg-white px-3 text-sm text-slate-900"
                    >
                      <option value="crm">Global scope</option>
